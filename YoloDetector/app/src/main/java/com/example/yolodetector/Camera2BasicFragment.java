//Camera interface reference: https://github.com/tensorflow/tensorflow/blob/master/tensorflow/lite/java/demo/
//All referenced part in this file does not contain object detector's core algorithm.
//Text-to-speech code is inserted to this file, but has nothing borrowed from the above reference.
//All text-to-speech components are marked out in their own sections
...
public class Camera2BasicFragment extends Fragment
    ...
    private void updateActiveModel() {
        ...
        backgroundHandler.post(() -> {
            ...
            try {
                detector = new YOLOv2(getActivity());
            ...
            //cpu should be default, set thread to 4
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        //ed1 = (EditText) view.findViewById(R.id.editText5);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String toSpeak = detector.getObjLocation();
    ...
    private Runnable periodicClassify =
            new Runnable() {
                ...
                public void run() {
                    synchronized (lock) {
                        if (runClassifier) {
                            classifyFrame();  //TODO: detectFrame()
                        }
                    }
                    backgroundHandler.post(periodicClassify);
                }
    ...
    private void classifyFrame() {
        ...
        if (detector == null || getActivity() == null || cameraDevice == null) {
            ...
            // showToast("Uninitialized detector or invalid context.");
            return;
        }
        SpannableStringBuilder textToShow = new SpannableStringBuilder();
        Bitmap bitmap = textureView.getBitmap(detector.getW(), detector.getH());
        detector.detectFrame(bitmap, textToShow);
        bitmap.recycle();
